...
\clearpage
\begin{table}
\caption{Wyniki klasyfikacji w zależności od wybranej metryki dla wszystkich cech}
\centering
\begin{tabular}{lllll}
...
\clearpage
\begin{table}
\caption{Wyniki klasyfikacji w zależności od wybranej metryki dla cech liczbowych}
\centering
\begin{tabular}{lllll}
                                                                              & metryka    & Czebyszewa & Uliczna & Euklidesowa  \\ 
\hline
