...
Podczas eksperymentów dotyczących porównania wyników klasyfikacji metody $k$-NN dla różnych wartości parametru k przyjęliśmy następujące paarmetry, które pozostawały stałe w trakcie badań:
\begin{itemize}
...
\clearpage
\begin{table}
\caption{Wyniki klasyfikacji w zależności od parametru $k$}
\centering
