...
public class RightTrapezoidalMembershipFunction extends TrapezoidalMembershipFunction{
    public RightTrapezoidalMembershipFunction(double x1, double x2, double x3) {
        super(x1, x2, x3);
    }
