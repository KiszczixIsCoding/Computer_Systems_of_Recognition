...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item stary
        \begin{equation}
            \mu_{stary}(x) = \left\{\begin{matrix} 0 & dla \: x\in [18;34) \\ 0.5x - 17 & dla \: x\in[34;36) \\ 1 & dla \: x\in [36; 44] \end{matrix}\right.
        \end{equation}
    \end{itemize}
     \begin{figure}[H]
    \centering
    ...
    \label{rysunek:wiek}
\end{figure}
    \item wzrost zawodnika - przestrzeń rozważań: $[160.03;231.14]$
    \begin{itemize}
        \item niski
        \begin{equation}
        ...
        \begin{equation}
            \mu_{sredniegowzrostu}(x) = \left\{\begin{matrix} 0 & dla \: x\in (160.03;185] \\ 0.1x - 18.5 & dla \: x\in[185;195) \\ -0.1x + 20.5 & dla \: x\in [195; 205] \\ 0 & dla \: x\in (205;231.14] \end{matrix}\right.
        \end{equation}
        \item wysoki
        \begin{equation}
    ...
    \end{figure}
    \item waga zawodnika - przestrzeń rozważań: $[60.33;163.29]$
    \begin{itemize}
        \item lekki
        \begin{equation}
    ...
    \end{figure}
    \item procent asyst - przestrzeń rozważań: $[0;1]$
    \begin{itemize}
        \item fatalny
        \begin{equation}
        ...
        \item mały
        \begin{equation}
            \mu_{maly\_asyst}(x) = \left\{\begin{matrix} 0 & dla \: x\in [0;0.01) \\ 25x-0.25 & dla \: x\in[0.01;0.05) \\ 1 & dla \: x\in [0.05; 0.06) \\ -25x + 2.5 & dla \: x\in[0.06;0.10] \\ 0 & dla \: x\in (0.06;1] \end{matrix}\right.
        \end{equation}
        \item przeciętny
        \begin{equation}
